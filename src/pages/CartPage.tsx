  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center space-y-6">
        ...
        <Link to="/produk" className="bg-brand-blue text-white px-8 py-3 rounded-xl font-bold hover:brightness-110 transition-all">
          Belanja Sekarang
        </Link>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 pb-20 pt-12">
      ...
      <section className="mt-24 py-16 bg-brand-blue relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <button className="bg-brand-yellow text-brand-dark px-10 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-all shadow-2xl shrink-0">
            Lihat Layanan Kami
          </button>
        </div>
      </section>
