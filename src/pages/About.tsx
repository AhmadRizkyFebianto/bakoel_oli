...
import { Zap, Settings, Wrench, Users, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500 max-w-3xl mx-auto text-lg">
              Bengkel <span className="text-brand-yellow font-bold">Bakul Oli</span> hadir dengan layanan cepat, profesional, dan terpercaya. Harga bersahabat serta teknisi ahli menjaga performa kendaraan Anda tetap optimal.
            </p>
          </div>
      ...
      <section className="py-20 bg-brand-blue relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <Link to="/layanan" className="bg-brand-yellow text-brand-dark px-10 py-5 rounded-[2rem] font-bold text-xl hover:scale-105 transition-all shadow-2xl shrink-0">
            Lihat Layanan Kami
          </Link>
        </div>
      </section>
