        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li><Link to="/" className="hover:text-brand-yellow">Beranda</Link></li>
              <li><Link to="/tentang-kami" className="hover:text-brand-yellow">Tentang Kami</Link></li>
              <li><Link to="/produk" className="hover:text-brand-yellow">Produk</Link></li>
              <li><Link to="/layanan" className="hover:text-brand-yellow">Layanan</Link></li>
              <li><Link to="#" className="hover:text-brand-yellow">Kontak</Link></li>
            </ul>
          </div>
