...
import { ChevronRight, Zap, Settings, Users, Wrench } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/layanan" className="bg-brand-yellow text-brand-dark px-8 py-3 rounded-lg font-bold hover:scale-105 transition-all shadow-lg flex items-center gap-2">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/produk" className="text-brand-dark font-semibold hover:text-brand-blue flex items-center gap-1 group">
