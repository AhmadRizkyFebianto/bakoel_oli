        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-500 max-w-3xl mx-auto text-lg">
              Bengkel{" "}
              <span className="text-brand-yellow font-bold">Bakul Oli</span>{" "}
              hadir dengan layanan cepat, profesional, dan terpercaya. Harga
              bersahabat serta teknisi ahli menjaga performa kendaraan Anda
              tetap optimal.
            </p>
          </div>
